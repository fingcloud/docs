...
![choose account](/docs/images/cli-browser-choose-account.jpg)
...
![choose account](/docs/images/cli-browser-access.jpg)
...
شما می‌توانید با دستور `fing auth ls` لیست اکانت‌‌های لاگین شده‌ی خود را مشاهده نمایید.
