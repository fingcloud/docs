...
برای اجرای برنامه، با توجه به هر یک از دستورهایی که به وسیله‌ی آن پروژه **ریکت** خود را ایجاد کرده باشیم، برنامه را با دستور
`npm start` یا `yarn start` و یا با دستور اجرا می‌کنیم.
