...
- شما باید خود **Flask** را نصب کنید یا حداقل محیط‌های مجازی را همانطور که در [راهنمای نصب](https://flask.palletsprojects.com/en/1.1.x/installation/#virtual-environments) فلاسک توصیه شده است راه‌اندازی کنید.
