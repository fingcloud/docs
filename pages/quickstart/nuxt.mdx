...
با اجرای دستور `npx create-nuxt-app hello-nuxt` یا `yarn create nuxt-app hello-nuxt` یک برنامه‌ی **Nuxt** ایجاد می‌کنیم تا تنظیمات و همچنین وابستگی‌های پیش فرض آن به صورت خودکار به پروژه اضافه شود.
...
- با اجرا کردن دستور ساخت، یک برنامه‌ی **nuxt** برای ما ایجاد می‌شود
...
برنامه‌ی **nuxt** ما آماده‌ی استقرار بر روی **سکوی ابری فینگ** می‌باشد و این بدین معناست که ما برای مدیریت برنامه‌های خود به **فینگ cli** نیاز داریم. اگر هنوز آن را نصب نکرده‌اید به [راهنمای نصب](/quickstart/installation) ما بروید و بعد از نصب، در آن [لاگین](/quickstart/login) کنید.
